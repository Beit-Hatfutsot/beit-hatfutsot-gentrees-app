...
var familyTpl = function (model) {
    ...
    var arr = _.flatten([
        ...
        '1 WIFE @momsMom@',
        '1 CHIL @mom@',
        model.momsBrothers.map(function (b, i) {
        ...
        '1 WIFE @dadsMom@',
        '1 CHIL @dad@',
        model.dadsBrothers.map(function (b, i) {
        ...
        '1 WIFE @mom@',
        '1 CHIL @me@',
        model.brothers.map(function (b, i) {
...
function addCommentToGetcoms (model){
    return ['1 NOTE ' +'Stockpile '+ model.savingLocation];
}
    ...
    var individualsGedcoms =
        _.flatten(
            _.map(model, function (v, k) {
                ...
                } else if (k === 'numBrothers' || k === 'numDadsBrothers' || k === 'numMomsBrothers' || k === 'image' || k === 'savingLocation') {
                    return '';
                } else {
